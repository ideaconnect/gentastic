<p align="center">
  <img src="assets/icon-app.png" width="160" alt="Gentastic" />
</p>
...
BSD 3-Clause © IDCT Bartosz Pachołek (see [LICENSE](LICENSE)). Gentastic redistributes third-party
components under their own licenses - MIT (StableDiffusion.NET, stable-diffusion.cpp, ggml, WPF-UI,
CommunityToolkit.Mvvm, Vortice.Windows, .NET/WPF), Apache-2.0 (FontAwesome.Sharp), **LGPL-2.1**
(HPPH, dynamically linked), and CC BY 4.0 / SIL OFL 1.1 (Font Awesome Free icons). The NVIDIA CUDA
runtime and the AI models are fetched at runtime from their vendors under their own terms and are not
bundled. Full attributions, obligations, and license texts are in
[THIRD_PARTY_NOTICE.md](THIRD_PARTY_NOTICE.md) and [`licenses/`](licenses/). FLUX models carry their
own licenses (schnell: Apache-2.0; dev and its finetunes: non-commercial).
